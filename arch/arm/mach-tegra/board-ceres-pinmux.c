...
static __initdata struct tegra_drive_pingroup_config ceres_drive_pinmux[] = {
	...
	SET_DRIVE_WITH_TYPE(GMA, ENABLE, DISABLE, DIV_1, 1, 2, FASTEST,
								FASTEST, 1),
	/* SPI2 */
	SET_DRIVE(SPI2, DISABLE, DISABLE, DIV_1, 16, 16, SLOWEST, SLOWEST),

	/* SPI3 */
	SET_DRIVE(SPI3, DISABLE, DISABLE, DIV_1, 16, 16, SLOWEST, SLOWEST),

	SET_DRIVE(AO1, DISABLE, DISABLE, DIV_1, 0, 0, SLOWEST, SLOWEST),

	SET_DRIVE(DDC, DISABLE, DISABLE, DIV_1, 0, 0, FASTEST, SLOWEST),

	SET_DRIVE(GME, DISABLE, DISABLE, DIV_1, 0, 0, SLOWEST, SLOWEST),
};
