...
#define PINGROUPS	\
	...
	PINGROUP(DDC_SCL,	  PM4,		LCD,	    I2C4,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3114),\
	PINGROUP(DDC_SDA,	  PM5,		LCD,	    I2C4,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3118),\
	...
	PINGROUP(UART1_RXD,	  PQ1,		UART,      RSVD0,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x34f4),\
	PINGROUP(UART1_TXD,	  PQ0,		UART,      RSVD0,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x34f8),\
	PINGROUP(UART1_RTS_N,	  PQ2,		UART,      RSVD0,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x34fc),\
	PINGROUP(UART1_CTS_N,	  PQ3,		UART,      RSVD0,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3500),\
