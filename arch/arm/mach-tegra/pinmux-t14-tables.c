...
#define PINGROUPS	\
	...
	PINGROUP(GPIO_PO4,	  PO4,		UART,       SOC,	SOC_ALT,    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3504),\
	PINGROUP(GPIO_PO5,	  PO5,		UART,       SOC,	SOC_ALT,    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3508),\
	PINGROUP(GPIO_PO6,	  PO6,		UART,       OWR,	SOC,	    SOC_ALT,	RSVD3,	     RSVD,	INPUT,	0x350c),\
