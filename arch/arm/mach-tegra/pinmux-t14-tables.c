...
#define PINGROUPS	\
	...
	PINGROUP(DDC_SCL,	  PN6,		LCD,	    I2C4,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3114),\
	PINGROUP(DDC_SDA,	  PN7,		LCD,	    I2C4,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3118),\
	PINGROUP(UART2_RXD,	  PF6,		UART,	    UARTB,	I2S3,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3164),\
	PINGROUP(UART2_TXD,	  PF5,		UART,	    UARTB,	I2S3,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3168),\
	PINGROUP(UART2_RTS_N,	  PF7,		UART,	    UARTB,	I2S3,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x316c),\
	PINGROUP(UART2_CTS_N,	  PG0,		UART,	    UARTB,	I2S3,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3170),\
	PINGROUP(UART3_TXD,	  PK0,		SYS,	    UARTC,	SPI2,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3174),\
	PINGROUP(UART3_RXD,	  PK1,		SYS,	    UARTC,	SPI2,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3178),\
	PINGROUP(UART3_CTS_N,	  PK3,		SYS,	    UARTC,	SPI2,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x317c),\
	PINGROUP(UART3_RTS_N,	  PK2,		SYS,	    UARTC,	SPI2,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3180),\
	PINGROUP(GEN2_I2C_SCL,	  PL5,		SYS,	    I2C2,	UARTD,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3250),\
	PINGROUP(GEN2_I2C_SDA,	  PL6,		SYS,	    I2C2,	UARTD,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3254),\
	...
	PINGROUP(KB_COL0,	  PV4,	 	SYS,	    KBC,	RSVD1,	    RSVD2,	RSVD3,       RSVD,	INPUT,	0x32fc),\
	PINGROUP(KB_COL1,	  PV5,		SYS,	    KBC,	RSVD1,	    RSVD2,	RSVD3,       RSVD,	INPUT,	0x3300),\
	PINGROUP(KB_COL2,	  PV6,		SYS,	    KBC,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3304),\
	...
	PINGROUP(SPI2_CS2_N,	  PH1,		AUDIO,      SPI2,	SPI1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x338c),\
	...
	PINGROUP(GPS_AP_INT,	  PI1,		AUDIO,      RSVD0,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x3460),\
	...
	PINGROUP(DDR0_A0,	  PP0,		DDR,        DDR0,	UARTA,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x34e4),\
	PINGROUP(DDR0_A1,	  PP1,		DDR,        DDR0,	UARTA,	    RSVD2,	RSVD3,	     RSVD,	INPUT,	0x34e8),\
	PINGROUP(DDR0_A2,	  PP2,		DDR,        DDR0,	UARTA,	    RSVD2,	SPI3,	     RSVD,	INPUT,	0x34ec),\
	PINGROUP(DDR0_A3,	  PP3,		DDR,        DDR0,	UARTA,	    RSVD2,	SPI3,	     RSVD,	INPUT,	0x34f0),\
