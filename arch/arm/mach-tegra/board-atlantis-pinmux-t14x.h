/* arch/arm/mach-tegra/board-atlantis-pinmux-t14x.h
 *
...
static __initdata struct tegra_pingroup_config atlantis_unused_pins_lowpower[] = {
};

static __initdata struct tegra_pingroup_config atlantis_pinmux_common[] = {
	...
	/* PG pinmux */
	DEFAULT_PINMUX(PG_OC,    PG,      PULL_UP,    NORMAL,   INPUT),
	...
	/* UARTA pinmux */
	DEFAULT_PINMUX(DDR0_A0,     UARTA,       NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(DDR0_A1,     UARTA,       NORMAL,    NORMAL,   OUTPUT),
	DEFAULT_PINMUX(DDR0_A2,     UARTA,       NORMAL,    NORMAL,   INPUT),
	DEFAULT_PINMUX(DDR0_A3,     UARTA,       NORMAL,    NORMAL,   OUTPUT),
