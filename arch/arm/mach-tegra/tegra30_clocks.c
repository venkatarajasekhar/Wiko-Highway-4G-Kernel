	...
	list_for_each_entry(c, &bus->shared_bus_list,
		...
		if (c->u.shared_bus_user.enabled ||
			...
			case SHARED_CEILING_BUT_ISO:
				ceiling_but_iso = min(c->u.shared_bus_user.rate,
						      ceiling_but_iso);
				break;
			case SHARED_CEILING:
...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("sata_oob",	"tegra_sata_oob",	NULL,	123,	0x420,	272000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	PERIPH_CLK("sata",	"tegra_sata",		NULL,	124,	0x424,	272000000, mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
