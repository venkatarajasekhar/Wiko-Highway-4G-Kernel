...
static __initdata struct tegra_pingroup_config m2601_pinmux_B00[] = {
	/* SDMMC2 pinmux */
        DEFAULT_PINMUX(KB_ROW10,        SDMMC2,         PULL_DOWN,      NORMAL,         OUTPUT),
        DEFAULT_PINMUX(KB_ROW11,        SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW12,        SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW13,        SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW14,        SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW15,        SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW6,         SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW7,         SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW8,         SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
        DEFAULT_PINMUX(KB_ROW9,         SDMMC2,         PULL_DOWN,      NORMAL,         INPUT),
	...
	DEFAULT_PINMUX(ULPI_DATA3,	ULPI,		PULL_UP,	NORMAL,		OUTPUT),
	...
	DEFAULT_PINMUX(CLK2_OUT,	RSVD1,		PULL_DOWN,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(GPIO_PV2,	RSVD1,		NORMAL,		NORMAL,		OUTPUT),
	DEFAULT_PINMUX(GPIO_PV3,	RSVD1,		NORMAL,		NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC1_CLK,	RSVD1,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT0,	RSVD1,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT1,	RSVD1,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT6,	SDMMC3,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT7,	SDMMC3,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(CLK3_OUT,	RSVD1,		PULL_DOWN,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(CLK3_REQ,	RSVD1,		NORMAL,		NORMAL,		OUTPUT),
	...
	DEFAULT_PINMUX(SDMMC3_CLK,	PWM2,		PULL_UP,	NORMAL,		OUTPUT),
	DEFAULT_PINMUX(SDMMC3_CMD,	PWM3,		PULL_UP,	NORMAL,		OUTPUT),

	/* PCIE  - Please review the change*/

	DEFAULT_PINMUX(PEX_L0_CLKREQ_N,	PCIE,		NORMAL,		NORMAL,		INPUT),
	DEFAULT_PINMUX(PEX_L0_PRSNT_N,	PCIE,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(PEX_L0_RST_N,	PCIE,		NORMAL,		NORMAL,		OUTPUT),
	DEFAULT_PINMUX(PEX_L1_CLKREQ_N,	PCIE,		NORMAL,		TRISTATE,	INPUT),
	DEFAULT_PINMUX(PEX_L1_PRSNT_N,	PCIE,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(PEX_L1_RST_N,	PCIE,		NORMAL,		NORMAL,		OUTPUT),
	DEFAULT_PINMUX(PEX_L2_CLKREQ_N,	PCIE,		NORMAL,		TRISTATE,	INPUT),
	DEFAULT_PINMUX(PEX_L2_PRSNT_N,	PCIE,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(PEX_L2_RST_N,	PCIE,		NORMAL,		NORMAL,		OUTPUT),

	DEFAULT_PINMUX(SPI1_CS0_N,	SPI1,		PULL_UP,	TRISTATE,	OUTPUT),
	DEFAULT_PINMUX(SPI1_MOSI,	SPI1,		PULL_UP,	TRISTATE,	OUTPUT),
	DEFAULT_PINMUX(ULPI_DATA2,	ULPI,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(CAM_I2C_SCL,	RSVD2,		NORMAL,		TRISTATE,	INPUT),
	DEFAULT_PINMUX(CAM_I2C_SDA,	RSVD2,		NORMAL,		TRISTATE,	INPUT),
	DEFAULT_PINMUX(CAM_MCLK,	POPSDMMC4,	PULL_UP,	TRISTATE,	OUTPUT),
	DEFAULT_PINMUX(SDMMC3_DAT2,	SDMMC3,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(SDMMC3_DAT3,	SDMMC3,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(SDMMC3_DAT4,	SDMMC3,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(SDMMC3_DAT5,	SDMMC3,		PULL_UP,	TRISTATE,	INPUT),
	DEFAULT_PINMUX(SPI1_SCK,	SPI1,		PULL_UP,	TRISTATE,	OUTPUT)
};

static __initdata struct tegra_pingroup_config m2601_pinmux_A00[] = {
...
int __init m2601_pinmux_init(void)
{
	...
	if (system_rev == TEGRA_M2601_SKU1_A00) {
		tegra_pinmux_config_table(m2601_pinmux_A00,
					ARRAY_SIZE(m2601_pinmux_A00));
	}else{
		/* Default to B00 */
		tegra_pinmux_config_table(m2601_pinmux_B00,
					ARRAY_SIZE(m2601_pinmux_B00));
...
static struct gpio_init_pin_info m2601_gpios_A00[] = {
...
static struct gpio_init_pin_info m2601_gpios_B00[] = {
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PK6,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PK5,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PW2,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PW3,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO4,	false, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PV2,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PZ0,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PB7,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PB6,	false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PEE0,	false, 0),
