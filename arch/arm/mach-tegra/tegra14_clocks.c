...
struct clk tegra_list_clks[] = {
	...
	SHARED_SCLK("sbc1.sclk", "tegra14-spi.0",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("sbc2.sclk", "tegra14-spi.1",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
	SHARED_SCLK("sbc3.sclk", "tegra14-spi.2",	"sclk", &tegra_clk_apb,        NULL, 0, 0),
