...
/* For LV(Low voltage) pad group which has IO_RESET bit */
#define SDMMC4_PINMUX(_pingroup, _mux, _pupd, _tri, _io, _lock, _ioreset) \
	{							\
		.pingroup	= TEGRA_PINGROUP_##_pingroup,	\
		.func		= TEGRA_MUX_##_mux,		\
		.pupd		= TEGRA_PUPD_##_pupd,		\
...
static __initdata struct tegra_pingroup_config p1852_pinmux_common[] = {
	...
	/* SDMMC2 pinmux */
	DEFAULT_PINMUX(KB_ROW10,	SDMMC2,		NORMAL,		TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW11,	SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW12,	SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW13,	SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW14,	SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW15,	SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW6,		SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW7,		SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW8,		SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	DEFAULT_PINMUX(KB_ROW9,		SDMMC2,		PULL_UP,	TRISTATE,		INPUT),
	...
	DEFAULT_PINMUX(ULPI_DATA2,	UARTA,		NORMAL,		TRISTATE,		INPUT),
	...
	/* UART5 pinmux */
	SDMMC4_PINMUX(SDMMC4_DAT0,	UARTE,		NORMAL,		NORMAL,		OUTPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT1,	UARTE,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT2,	UARTE,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT3,	UARTE,		NORMAL,		NORMAL,		OUTPUT,	DISABLE,	DISABLE),
	...
	DEFAULT_PINMUX(DAP3_DOUT,	I2S2,		NORMAL,		TRISTATE,		INPUT),
	DEFAULT_PINMUX(DAP3_SCLK,	I2S2,		NORMAL,		TRISTATE,		INPUT),

	/* I2S4 */
	SDMMC4_PINMUX(SDMMC4_DAT4,	I2S4,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT5,	I2S4,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT6,	I2S4,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	SDMMC4_PINMUX(SDMMC4_DAT7,	I2S4,		NORMAL,		NORMAL,		INPUT,	DISABLE,	DISABLE),
	...
	DEFAULT_PINMUX(PEX_L1_PRSNT_N,	PCIE,		NORMAL,		TRISTATE,		INPUT),
	...
	SDMMC4_PINMUX(SDMMC4_CLK,	NAND,	NORMAL,	NORMAL,	INPUT,	DISABLE,	DISABLE),
