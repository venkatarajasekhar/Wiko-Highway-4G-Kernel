...
static struct cpu_cvb_dvfs cpu_cvb_dvfs_table[] = {
	{
		...
		.dfll_tune_data  = {
			.tune0		= 0x00b00380,
			.tune0_high_mv	= 0x00b00380,
			.tune1		= 0x000005e0,
			.droop_rate_min = 1000000,
			.tune_high_min_millivolts = 0,
			.min_millivolts = 900,
		},
		.max_mv = 1250,
		.freqs_mult = KHZ,
...
static const int core_millivolts[MAX_DVFS_FREQS] = {
	810, 850, 900, 950, 1000, 1050, 1100};
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",  -1, 1, KHZ,      1,      1, 201600, 201600, 240000, 297600, 355200),

	CORE_DVFS("3d",      -1, 1, KHZ,      1,      1, 134400, 172800, 230400, 268800, 364800),
	CORE_DVFS("2d",      -1, 1, KHZ,      1,      1, 115200, 153600, 192000, 230400, 288000),
	CORE_DVFS("epp",     -1, 1, KHZ,      1,      1, 115200, 153600, 192000, 230400, 288000),

	CORE_DVFS("se",      -1, 1, KHZ,      1,      1, 115200, 134400, 172800, 211200, 268800),
	CORE_DVFS("vde",     -1, 1, KHZ,      1,      1, 115200, 134400, 172800, 211200, 268800),

	CORE_DVFS("msenc",   -1, 1, KHZ,      1,      1,  72000,  82400, 105300, 129100, 153000),
	CORE_DVFS("tsec",    -1, 1, KHZ,      1,      1, 165900, 202100, 258200, 316400, 375000),
	CORE_DVFS("host1x",  -1, 1, KHZ,      1,      1,  99500, 121200, 154900, 189800, 225000),
	CORE_DVFS("vi",      -1, 1, KHZ,      1,      1, 135300, 164900, 210700, 258100, 306000),
	CORE_DVFS("isp",     -1, 1, KHZ,      1,      1, 135300, 164900, 210700, 258100, 306000),
	CORE_DVFS("sbus",    -1, 1, KHZ,      1,      1, 103500, 126100, 161100, 197400, 234000),

	CORE_DVFS("emc",     -1, 1, KHZ,      1,      1,      1,      1,      1,      1, 1066000),

#ifdef CONFIG_TEGRA_DUAL_CBUS
	CORE_DVFS("c2bus", -1, 1, KHZ,        1,      1, 115200, 153600, 192000, 230400, 288000),
	CORE_DVFS("c3bus", -1, 1, KHZ,        1,      1, 115200, 134400, 172800, 211200, 268800),
#else
	CORE_DVFS("cbus",  -1, 1, KHZ,        1,      1, 115200, 134400, 172800, 211200, 268800),
#endif
	/* Core voltages (mV):		    810,    850,    900,    950,   1000,   1050,   1100 */
	...
	CORE_DVFS("dsia",  -1, 1, KHZ,        1,      1, 75000, 75000, 86100, 105500, 125000),
	CORE_DVFS("dsib",  -1, 1, KHZ,        1,      1, 75000, 75000, 86100, 105500, 125000),
	CORE_DVFS("dsialp",  -1, 1, KHZ,        1,      1, 72000, 72000, 77500, 94900, 112500),
	CORE_DVFS("dsiblp",  -1, 1, KHZ,        1,      1, 72000, 72000, 77500, 94900, 112500),
	CORE_DVFS("hdmi",  -1, 1, KHZ,        1,      1, 111300, 135600, 173200, 212300, 270000),
	/*
	 ...
	 */
	CORE_DVFS("disp1",  -1, 0, KHZ,        1,      1, 74300, 88900, 113600, 139200, 165000),
	CORE_DVFS("disp2",  -1, 0, KHZ,        1,      1, 74300, 88900, 113600, 139200, 165000),
#endif
};
