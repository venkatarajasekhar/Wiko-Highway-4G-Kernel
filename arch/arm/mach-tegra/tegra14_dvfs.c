...
static struct cpu_cvb_dvfs cpu_cvb_dvfs_table[] = {
	...
	},
	{
		...
		.cvb_table = {
			...
			{2116500, { 2975349,  -127783,   2073}, { 1300000,    0,    0} },
			{      0, {      0,      0,   0}, {      0,    0,    0} },
		},
		.therm_trips_table = { 20 },
		.therm_floors_table = { 900 },
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("cpu_lp",   0,  0, 1, KHZ,      249600, 249600, 364800, 460800, 556800, 633600, 691200, 730000, 730000, 730000, 730000),
	CORE_DVFS("cpu_lp",   0,  1, 1, KHZ,      310000, 310000, 398000, 492000, 565000, 657000, 730000, 730000, 730000, 730000, 730000),
	CORE_DVFS("cpu_lp",   1,  1, 1, KHZ,      310000, 310000, 398000, 492000, 565000, 657000, 730000, 784000, 784000, 784000, 784000),
	...
	CORE_DVFS("3d",       1,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 595200, 672000, 710400, 748800),
	CORE_DVFS("2d",       1,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 595200, 672000, 710400, 748800),
	CORE_DVFS("epp",      1,  1, 1, KHZ,      192000, 192000, 268800, 345600, 384000, 499200, 556800, 595200, 672000, 710400, 748800),
#endif
	...
	CORE_DVFS("se",       1,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 537600, 537600, 537600),
	CORE_DVFS("vde",      1,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 537600, 537600, 537600),
	...
	CORE_DVFS("msenc",    1,  1, 1, KHZ,       81600,  81600, 136000, 204000, 204000, 204000, 204000, 408000, 408000, 408000, 408000),
	...
	CORE_DVFS("tsec",     1,  1, 1, KHZ,      136000, 136000, 204000, 384000, 408000, 408000, 408000, 408000, 408000, 408000, 408000),
	...
	CORE_DVFS("host1x",   1,  1, 1, KHZ,      136000, 136000, 136000, 204000, 204000, 204000, 384000, 384000, 408000, 408000, 408000),
	...
	CORE_DVFS("sbus",     1,  1, 1, KHZ,      136000, 136000, 136000, 204000, 204000, 204000, 384000, 384000, 408000, 408000, 408000),
	...
	CORE_DVFS("c3bus",    1,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 537600, 537600, 537600),
#else
	...
	CORE_DVFS("cbus",     1,  1, 1, KHZ,      153600, 153600, 211200, 288000, 345600, 403200, 460800, 499200, 537600, 537600, 537600),
#endif
	/* Core voltages (mV):		             800,    825,    850,    900,    950,   1000,   1050,   1100,   1150,   1200,   1230 */
	...
	OVRRD_DVFS("sdmmc1", -1, -1, 1, KHZ,       51000,  51000,  51000,  51000,  51000,  51000,  51000, 136000, 136000, 136000, 204000),
	OVRRD_DVFS("sdmmc3", -1, -1, 1, KHZ,       51000,  51000,  51000,  51000,  51000,  51000,  51000, 136000, 136000, 136000, 204000),
	OVRRD_DVFS("sdmmc4", -1, -1, 1, KHZ,       51000,  51000,  51000,  51000,  51000,  51000,  51000, 136000, 136000, 136000, 192000),
