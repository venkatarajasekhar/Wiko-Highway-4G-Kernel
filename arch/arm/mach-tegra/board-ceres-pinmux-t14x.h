...
static __initdata struct tegra_pingroup_config ceres_pinmux_common[] = {
	...
	/* I2C3 pinmux */
	I2C_PINMUX(CAM_I2C_SCL, I2C3, NORMAL, NORMAL, OUTPUT, DEFAULT, DISABLE),
	I2C_PINMUX(CAM_I2C_SDA, I2C3, NORMAL, NORMAL, INPUT, DEFAULT, DISABLE),

	/* VI pinmux */
	VI_PINMUX(CAM1_MCLK, VI, NORMAL, NORMAL, OUTPUT, DEFAULT, DISABLE),

	/* VIMCLK2 pinmux */
	VI_PINMUX(CAM2_MCLK, VI_ALT2, NORMAL, NORMAL, OUTPUT, DEFAULT, DISABLE),
	...
	/* I2CPWR pinmux */
	I2C_PINMUX(PWR_I2C_SCL, I2CPWR, NORMAL, NORMAL, OUTPUT, DEFAULT, DISABLE),
	...
	/* GPIO pinmux */
	GPIO_PINMUX(AP_GPS_EN, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(AP_GPS_RST, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPS_AP_INT, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(DCA_LSPII, PULL_DOWN, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(DCA_LSC, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(DCA_LVS, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(SPI2_CS2_N, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS0, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS1, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS2, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS3, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS4, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PS5, NORMAL, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(AP_WIFI_EN, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(AP_WIFI_RST, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(AP_WAKE_BT, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(BT_WAKE_AP, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(BT_RESET_L, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(NFC_INT_L, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(NFC_EN, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(NFC_DATA_EN, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO0, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO1, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO2, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO3, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO4, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO5, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PO6, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(AP_READY, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(MODEM_WAKE_AP, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(MOTION_INT_L, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(ALS_PROX_INT_L, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(TOUCH_INT_L, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(TOUCH_RESET_L, NORMAL, NORMAL, INPUT, DISABLE),
...
static struct gpio_init_pin_info init_gpio_mode_ceres_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ4, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ5, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ6, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PJ1, true, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PN2, true, 0),
};
