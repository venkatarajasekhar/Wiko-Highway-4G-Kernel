...
//edit by Magnum 2013-11-08 show firmware id
...
static struct device_attribute attrs[] = {
	__ATTR(doreflash, S_IRUGO,
			synaptics_rmi4_show_error,
			fwu_sysfs_do_reflash_store),
	__ATTR(writeconfig, S_IRUGO,
			synaptics_rmi4_show_error,
			fwu_sysfs_write_config_store),
	__ATTR(readconfig, S_IRUGO,
			synaptics_rmi4_show_error,
			fwu_sysfs_read_config_store),
	__ATTR(configarea, S_IRUGO,
			synaptics_rmi4_show_error,
			fwu_sysfs_config_area_store),
	__ATTR(imagesize, S_IRUGO,
			synaptics_rmi4_show_error,
...
static enum flash_area fwu_go_nogo(struct image_header *header)
{
	int retval = 0;
	int index = 0;
	int deviceFirmwareID;  // vendor info
	int imageConfigID;
	int deviceConfigID;
...
//edit by Magnum 2013-11-08  get panel_version && vendor_version
